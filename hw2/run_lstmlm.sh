...
<<<<<<< HEAD
python3 main.py --network lstmlm --tt_num_iter=100000 --early_stop --bptt_len=35 --batch_sz=20 --t_lrn_rate=1.0 --t_lrn_decay=invlin --t_lrn_decay_rate=1.0 --m_word_features=100 --t_optimizer=sgd --t_clip_norm=5 --m_num_layers=2 --m_word_features=100 --m_dropout=0 --m_hidden_size=200
=======
...
>>>>>>> 7fd93e46cd7e219ec5070aad39c9ddead6a87de3
