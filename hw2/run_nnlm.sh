...
python3 main.py --network lstmlm --tt_num_iter=100000 --early_stop --bptt_len=36 --batch_sz=128 --t_lrn_rate=1.0 --t_lrn_decay=none --t_lrn_decay_rate=0.5 --m_word_features=100 --t_optimizer=sgd --t_clip_norm=5 --m_num_layers=2  --m_dropout=0.5 --m_hidden_size=512
